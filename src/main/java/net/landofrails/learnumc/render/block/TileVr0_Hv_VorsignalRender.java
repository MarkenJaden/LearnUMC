package net.landofrails.learnumc.render.block;
...
import net.landofrails.learnumc.LearnUMC;
...
public class TileVr0_Hv_VorsignalRender {
    ...
    private static void renderStuff(TileVr0_Hv_Vorsignal ts) {
        if (renderer == null || model == null) {
            try {
                model = new OBJModel(new Identifier(LearnUMC.MODID, "models/block/vr0_hv_vorsignal/vr0_hv_vorsignal.obj"), 0);
